...
<body>
	<table width="100%" height="70%" border="0" cellspacing="0"
		...
		<tr>
			...
			<!-- 				</td> -->
			<td width="100%" align="center" style="font-size: 15"><h1>商&nbsp;城&nbsp;后&nbsp;台&nbsp;管&nbsp;理&nbsp;系&nbsp;统</h1></td>
		</tr>
	</table>
						...
						<td width="85%" align="left">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <font color="#000000">
								<script language="JavaScript">
									...
									document.write(tmpDate.getFullYear());
									document.write("年");
									document.write(tmpDate.getMonth() + 1);
									document.write("月");
									document.write(tmpDate.getDate());
									document.write("日 ");
